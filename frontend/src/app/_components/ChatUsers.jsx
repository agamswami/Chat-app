...
const ChatUsers = () => {
  ...
  return (
    <div className="w-full max-w-xs bg-gray-900 text-white">
      <div className="p-2 text-lg font-bold border-b border-gray-700 h-[48px]">Chats</div>
      <div className="group h-[calc(100vh-48px-4rem)] overflow-y-auto
  scrollbar-thin
